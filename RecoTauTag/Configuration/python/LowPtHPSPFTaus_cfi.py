...
def addLowPtTaus(process):
    ...
    process.ak4PFJetsLegacyHPSPiZerosLowPt.minJetPt = cms.double(1.0) #jet pt> 1 GeV of threshold in input
    ...
    process.ak4PFJetsRecoTauChargedHadronsLowPt.minJetPt = cms.double(1.0)#jet pt> 1 GeV of threshold in input
    process.ak4PFJetsRecoTauChargedHadronsLowPt.builders[1].dRcone = cms.double(0.3)
    ...
    process.combinatoricRecoTausLowPt.minJetPt = cms.double(1.0)
