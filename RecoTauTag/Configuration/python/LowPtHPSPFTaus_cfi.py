...
def addLowPtTaus(process):
    ...
    ##process.recoTauAK4PFJets08RegionLowPt.pfCandAssocMapSrc = cms.InputTag('LowPtTauSeeds', 'pfCandAssocMapForIsolation') #setted just by boosted taus subject finding 
